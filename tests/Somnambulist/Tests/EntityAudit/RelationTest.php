...
class RelationTest extends BaseTest
{
    protected $schemaEntities = [
        'Somnambulist\EntityAudit\Tests\OwnerEntity',
        'Somnambulist\EntityAudit\Tests\OwnedEntity1',
        'Somnambulist\EntityAudit\Tests\OwnedEntity2',
        'Somnambulist\EntityAudit\Tests\OwnedEntity3',
        'Somnambulist\EntityAudit\Tests\OneToOneMasterEntity',
        'Somnambulist\EntityAudit\Tests\OneToOneAuditedEntity',
        'Somnambulist\EntityAudit\Tests\OneToOneNotAuditedEntity',
        'Somnambulist\EntityAudit\Tests\Category',
        'Somnambulist\EntityAudit\Tests\FoodCategory',
        'Somnambulist\EntityAudit\Tests\Product',
        'Somnambulist\EntityAudit\Tests\WineProduct',
        'Somnambulist\EntityAudit\Tests\CheeseProduct',
        'Somnambulist\EntityAudit\Tests\Page',
        'Somnambulist\EntityAudit\Tests\PageLocalization',
        'Somnambulist\EntityAudit\Tests\RelationOneToOneEntity',
        'Somnambulist\EntityAudit\Tests\RelationFoobarEntity',
        'Somnambulist\EntityAudit\Tests\RelationReferencedEntity',
    ];
    ...
    public function testUndefinedIndexesInUOWForRelations()
    {
        ...
        $owner = $this->em->getReference("Somnambulist\\EntityAudit\\Tests\\OwnerEntity", 1);
        $this->em->remove($owner);
        $owned1 = $this->em->getReference("Somnambulist\\EntityAudit\\Tests\\OwnedEntity1", 1);
        $this->em->remove($owned1);
        $owned2 = $this->em->getReference("Somnambulist\\EntityAudit\\Tests\\OwnedEntity2", 1);
        ...
        $this->assertContainsOnly('Somnambulist\EntityAudit\ChangedEntity', $changedEntities);
        $this->assertEquals('Somnambulist\EntityAudit\Tests\OwnerEntity', $changedEntities[0]->getClassName());
        $this->assertEquals('Somnambulist\EntityAudit\Tests\OwnerEntity', get_class($changedOwner));
        $this->assertEquals('Somnambulist\EntityAudit\Tests\OwnedEntity1', get_class($changedOwned));
