 ...
 * @subpackage Somnambulist\EntityAudit\EventListener\LogRevisionsListener
 */
class LogRevisionsListener implements EventSubscriber
{
     ...
     * @throws \Doctrine\DBAL\DBALException
     */
    private function getInsertRevisionSQL(ClassMetadata $class, QuoteStrategy $quoteStrategy)
    {
    ...
    private function saveRevisionEntityData($class, $entityData, $revType)
    {
        ...
        $this->conn->executeUpdate(
            $this->getInsertRevisionSQL($class, $this->em->getConfiguration()->getQuoteStrategy()),
            $params,
            $types
        );
    }
